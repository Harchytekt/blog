...
<article>
    ...
    <div id="content">
        <p>Once the web page is complete this will read something different and more relevant. At some point someone
            ...
            page. It will be replaced with <a href="3.php"><span id="link" class="externalLink">real</span></a> content
            later. </p>
        ...
        <p>You are currently reading text that is written in English, not Latin. What you are reading now is not what
            you will be reading in this space once this web page is completed. Once the web page is complete this will
