...
<div id="tpopup">
    <iframe src="https://sixcolors.com"></iframe>
</div>
<!--<div id="popup">--><?php //include("index.php"); ?><!--</div>-->
<script>
    document.getElementById("link").addEventListener("mouseover", mouseOver);
    document.getElementById("tpopup").addEventListener("mouseover", mouseOver);
    document.getElementById("link").addEventListener("mouseout", mouseOut);
    document.getElementById("tpopup").addEventListener("mouseout", mouseOut);
    ...
    function getPoint() {
        ...
        /*console.log(
            ...
            " (" + target.offsetLeft + ", "
            + target.offsetTop + ")");*/
        document.getElementById("tpopup").style.top = `${targetTextRectangle.top}px`;
        document.getElementById("tpopup").style.left = `${targetTextRectangle.right}px`;
    }
</script>
</body>
</html>
